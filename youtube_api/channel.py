...
with open('channel.csv', 'a', newline='') as file:
    ...
    # writer.writerow(['Platform', 'Avatar', 'Channel Name', 'Channel Url', 'Location', 'Subscribers Count',
    #                  'Video count', 'Description', 'joined', 'Views', 'Email', '3 Latest Videos Url',
    #                  '3 Latest Videos Title',  '3 Latest videos image', 'other', 'title'])  # 'Latest Video 1', 'Latest Video 2', 'Latest Video 3'

    try:
        driver.get(f'https://www.youtube.com/@khalifahklothing/about')
        driver.refresh()
        ...
        writer.writerow(
            [platform, avatar, name, channel_url, location, subscribers_count, video_count, description,
             joined, views, email, latest_video_url, latest_video_title, latest_video_image, other_link,
