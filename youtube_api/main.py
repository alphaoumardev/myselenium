...
response = requests.get('https://www.youtube.com/feed/guide_builder',).text
...
for i in html_li:
    ...
    print('https://www.youtube.com' + i['gridChannelRenderer']['navigationEndpoint']['commandMetadata']['webCommandMetadata']['url'] + '/about')
    print('*' * 30)
