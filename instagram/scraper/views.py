...
from .models import Hashtag, Category
from .models import (
    InstagramAccount,
    InstagramPost,
...
class UpdateAccountsView(views.APIView):
    ...
    @staticmethod
    def update_single_post(account_obj, instagram_post_data):
        ...
        new_post, created = InstagramPost.objects.update_or_create(
            ...
            url_to_post="https://www.instagram.com/p/{}/".format(instagram_post_data.get('shortcode')),
            defaults={
        ...
        if created:
            print("{} Post created.".format(account_obj))
        else:
            print("{} Post updated.".format(account_obj))
    ...
    @staticmethod
    def create_report(profile_page_metrics, account_obj):
    ...
    @staticmethod
    def calculate_daily_growth(account_obj):
        # last 10 days max
    ...
    @staticmethod
    def calculate_acc_indicators(account_obj):
    ...
    def update_all_indicators(self, account_obj):
        ...
        account_objs = self.calculate_acc_indicators(account_obj)
...
class AddNewAccountView(views.APIView):
    ...
    @staticmethod
    def add_account(account_name, category, profile_page_metrics):
    ...
    @staticmethod
    def create_posts(account_object, profile_page_recent_posts):
        for post in profile_page_recent_posts:
            ...
            new_post, _ = InstagramPost.objects.update_or_create(
                ...
                url_to_post="https://www.instagram.com/p/{}/".format(post.get('shortcode')),
                defaults={
                    'added_to_ig': date_added,
    ...
    @staticmethod
    def create_report(account_object):
...
class HashtagMultiAddView(views.APIView):
    ...
    @staticmethod
    def add_new_hashtags(category_id, hashtags):
